...
if (isNil "ws_pre_init_done") then {ws_pre_init_done = false}; if (isServer) then {publicvariable "ws_pre_init_done";};
...
// BAF
//[[GrpBAF_CO,GrpBAF_ASL,GrpBAF_BSL,GrpBAF_CSL,GrpBAF_A1,GrpBAF_A2,GrpBAF_A3,GrpBAF_B1,GrpBAF_B2,GrpBAF_B3,GrpBAF_C1,GrpBAF_C2,GrpBAF_C3,GrpBAF_MMG1,GrpBAF_MMG2,GrpBAF_ENG1,GrpBAF_TH1,GrpBAF_TH2,GrpBAF_TH3,GrpBAF_AH1],80,1] execVM "f\server\f_endOnCasualtiesCap.sqf";

// UN
//[[GrpUN_CO,GrpUN_ASL,GrpUN_A1,GrpUN_A2,GrpUN_A3,GrpUN_BSL,GrpUN_B1,GrpUN_B2,GrpUN_B3],100,2] execVM "f\server\f_endOnCasualtiesCap.sqf";

//CHDZK
[[GrpA2INS_CO,GrpA2INS_ASL,GrpA2INS_BSL,GrpA2INS_CSL,GrpA2INS_A1,GrpA2INS_A2,GrpA2INS_A3,GrpA2INS_B1,GrpA2INS_B2,GrpA2INS_B3,GrpA2INS_C1,GrpA2INS_C2,GrpA2INS_C3,GrpA2INS_IFV1,GrpA2INS_IFV2,GrpA2INS_IFV3],100,2] execVM "f\server\f_endOnCasualtiesCap.sqf";

// USMC
[[GrpUSMC_CO,GrpUSMC_DC,GrpUSMC_ASL,GrpUSMC_BSL,GrpUSMC_CSL,GrpUSMC_A1,GrpUSMC_A2,GrpUSMC_A3,GrpUSMC_B1,GrpUSMC_B2,GrpUSMC_B3,GrpUSMC_C1,GrpUSMC_C2,GrpUSMC_C3,GrpUSMC_TH1,GrpUSMC_TH2,GrpUSMC_TH3,GrpUSMC_AH1],100,1] execVM "f\server\f_endOnCasualtiesCap.sqf";
