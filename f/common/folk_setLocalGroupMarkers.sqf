...
// Markers seen by players in USMC slots.
	...
	case "usmc":
	{
		...
		["GrpUSMC_MMG3", 2, "MMG3", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		["GrpUSMC_MAT3", 3, "MAT3", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		...
		["GrpUSMC_AH1",  8, "AH1", "ColorOrange"] spawn fnc_folk_localGroupMarker;
		...
		["GrpUSMC_A10",  8, "A10", "ColorRed"] spawn fnc_folk_localGroupMarker;
		["GrpUSMC_A10_1",  8, "A10", "ColorRed"] spawn fnc_folk_localGroupMarker;
