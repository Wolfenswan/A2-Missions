...
// Markers seen by players in US slots.
	...
	case "BIS_US":
	{
		...
		["GrpUS_ENG2",  6, "ENG1", "ColorYellow"] execVM  "f\common\folk_localGroupMarker.sqf";
...
// Markers seen by players in USMC slots.
	...
	case "USMC":
	{
		...
		["GrpUSMC_MMG2", 2, "MMG2", "ColorOrange"] execVM "f\common\folk_localGroupMarker.sqf";
		["GrpUSMC_MMG3", 2, "MMG3", "ColorOrange"] execVM "f\common\folk_localGroupMarker.sqf";
		...
		["GrpUSMC_ENG2",  6, "ENG2", "ColorYellow"] execVM  "f\common\folk_localGroupMarker.sqf";
